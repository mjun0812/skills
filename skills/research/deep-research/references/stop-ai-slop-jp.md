...
- [references/structures.md](stop-ai-slop-jp/structures.md) — 避けるべき構造パターン6系統。主体の消去、ドラマの偽造、英語ブログ骨格の直輸入、リズムの均一化、立場からの逃げ、無害さチューニング。
- [references/phrases.md](stop-ai-slop-jp/phrases.md) — 撲滅すべき語彙8系統。定型句と偏愛語、翻訳調、横文字メタファー、立場を薄める語、時間稼ぎと自己解説、強度の振り切り、ビジネス用語の濫用、機械処理の残骸。
