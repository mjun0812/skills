...
description: >-
  ...
  weztermと明示されていないpane/tab操作の依頼 (ユーザーはtmuxとHerdrも併用している)、tmuxの操作、wezterm自体の設定 (wezterm.luaやkeybinding) の変更には使わない。
...
自分が動いているpaneや依頼外のpaneに影響を与えずに目的のpaneだけを操作し、送ったコマンドの結果まで確認して報告するSkill。
